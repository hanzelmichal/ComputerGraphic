...
public class Zadanie1 extends JPanel {
    ...
    private void drawWorld(Graphics2D g2) {
        ...
        AffineTransform basicTransform = g2.getTransform(); //do resetowania ustawieñ
       
        //obiekt 1
        //piêciok¹t 1
        g2.setColor(Color.BLACK);
        g2.translate(-1.1, -0.3); //przesuniêcie
        ...
        //piêciok¹t 1
        g2.setColor(Color.BLACK);
        g2.translate(-3.1, 2.3); //przesuniêcie
        g2.scale(0.5, 0.5);
        rotatingPolygon(g2); //stworzenie
        g2.setTransform(basicTransform); //reset
        ...
        //piêciok¹t 1
        g2.setColor(Color.BLACK);
        g2.translate(1.9, 2.7); //przesuniêcie
        g2.scale(0.3, 0.3);
        rotatingPolygon(g2); //stworzenie
        g2.setTransform(basicTransform); //reset
    ...
    */
    ...
    private static void filledPolygon(Graphics2D g2) {
        Polygon p = new Polygon(); //piêciok¹t
        for (int i = 0; i < 15; i++)
