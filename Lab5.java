...
public class Main extends GLJPanel implements GLEventListener, KeyListener{
    ...
    private void draw(GL2 gl2) {
        ...
        else if (objectNumber == 2){        //piramida //15 jest liczbą n którą możemy zmienić w zależności od n-kątów wielokąta
            Piramida(gl2,15);
        }
    }
