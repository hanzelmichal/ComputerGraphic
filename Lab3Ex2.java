...
public class SceneGraph extends JPanel {
    ...
    private void createWorld() {
        ...
        triangle3.setScale(0.24, 0.66).setTranslation(2.25, 1.95).setColor(Color.GREEN);
        world.add(triangle3);
    } // end createWorld()
    ...
    public void updateFrame() {
        ...
        rotatingPolygon1.setRotation(frameNumber*5);
        rotatingPolygon2.setRotation(frameNumber*5);
        rotatingPolygon3.setRotation(frameNumber*5);
        rotatingPolygon4.setRotation(frameNumber*5);
        rotatingPolygon5.setRotation(frameNumber*5);
        rotatingPolygon6.setRotation(frameNumber*5);
    ...
    private static SceneGraphNode filledPolygon = new SceneGraphNode() {
        ...
        Polygon p = new Polygon(); //pięciokąt
        for (int i = 0; i < 15; i++)
